...
const PreselectionPage: React.FC = () => (
    <div className="animate-fade-in-up space-y-8">
        <div>
            <h1 className="text-4xl font-extrabold text-gray-900 mb-4">Pre selección y Selección de Personal</h1>
            <p className="text-lg text-gray-600">Nuestro compromiso con atraer y contratar al mejor talento.</p>
        </div>
        <div className="bg-white border border-gray-100 p-8 rounded-xl shadow-md">
            <div className="flex items-start space-x-4">
                <div className="bg-red-100 p-3 rounded-lg">
                    <UserSearch className="h-8 w-8 text-red-600" />
                </div>
                <div>
                    <h3 className="text-2xl font-bold text-gray-900">Proceso de Selección de Talento</h3>
            ...
            <div className="mt-8">
                <h4 className="text-xl font-bold text-gray-900 mb-4">Fases de Nuestro Proceso</h4>
